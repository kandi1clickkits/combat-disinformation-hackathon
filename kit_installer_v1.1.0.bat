...
ECHO 	You can track the progress in the log.txt file while it's getting installed
ECHO======================================================================================
...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/combat-disinformation-hackathon/releases/download/v1.1.0/combat-disinformation-hackathon.zip
SET REPO_DEPENDENCIES_URL=https://raw.githubusercontent.com/kandi1clickkits/combat-disinformation-hackathon/main/requirements.txt
SET REPO_NAME=combat-disinformation-hackathon.zip
SET EXTRACTED_REPO_DIR=combat-disinformation-hackathon
SET NOTEBOOK_NAME=FakeNewsdetection-starter.ipynb
ECHO Kit installing...
CALL :Main >> log.txt 2>&1
ECHO==========================================================================
ECHO 	The Kit has been executed
ECHO==========================================================================
